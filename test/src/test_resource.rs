...
pub fn resource_make<'a>(env: NifEnv<'a>, _args: &Vec<NifTerm>) -> NifResult<NifTerm<'a>> {
...
pub fn resource_set_integer_field<'a>(env: NifEnv<'a>, args: &Vec<NifTerm>) -> NifResult<NifTerm<'a>> {
...
pub fn resource_get_integer_field<'a>(env: NifEnv<'a>, args: &Vec<NifTerm>) ->  NifResult<NifTerm<'a>> {
    let resource: ResourceCell<TestResource> = try!(args[0].decode());
